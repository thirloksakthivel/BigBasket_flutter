      ...
      child: Scaffold(
        body: VStack([
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(
                      'https://media.istockphoto.com/id/1411375497/vector/truck-delivery-service-black-silhouette-icon-cargo-van-fast-shipping-glyph-pictogram-courier.jpg?b=1&s=170667a&w=0&k=20&c=EK13WGcfFzPW0k4JCv17vPO_SnSmxVkKKf6xNXE3sjo='),
                  fit: BoxFit.contain,
                ),
          ...
          ZStack([
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(
                      'https://t0.gstatic.com/images?q=tbn:ANd9GcQgTU0M4-86ZAzGrZ6vvFUWJkcFmTeJCROznSRflSK3QHsJec_B'),
                  fit: BoxFit.contain,
                ),
                borderRadius: BorderRadius.all(Radius.circular(50.0)),
                border: Border.all(
          ...
          ZStack([
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(
                      'https://thumbs.dreamstime.com/b/headphones-icon-vector-illustration-headphones-symbol-headphones-icon-vector-illustration-headphones-symbol-139226761.jpg'),
                  fit: BoxFit.contain,
                ),
                borderRadius: BorderRadius.all(Radius.circular(50.0)),
                border: Border.all(
          ...
          ZStack([
            ...
            Text(
              '  Aenean sollicitudin, lorem quis \n  biben dum auctor, nisi elit consequat',
              style: GoogleFonts.raleway(fontSize: 15),
            ).pOnly(left: 65, top: 250),
            Text(
              "\$399",
              style: GoogleFonts.poppins(fontSize: 40, color: Colors.red),
            ).pOnly(left: 85, top: 310),
            Container(
              decoration: BoxDecoration(
                  border: Border.all(width: 1, color: Colors.transparent),
          ...
          HStack([
            Container(
              ...
              child: Text(
                '<',
                style: GoogleFonts.raleway(fontSize: 60),
              ).centered(),
            ),
            Container(
              height: 80,
